...
const IndicadoresEquipamentos = ({ indicadores }) => {
  ...
  const detalhesMock = {
    "Equipamentos ativos": [
      { id: "E001", nome: "Balança Analítica", status: "Operacional", ultimaManutencao: "10/11" },
      { id: "E002", nome: "Espectrofotômetro", status: "Operacional", ultimaManutencao: "08/11" },
    ],
    "Em manutenção": [
      { id: "E010", nome: "Centrífuga", status: "Manutenção", prazo: "20/11" },
    ],
    "Disponíveis": [
      { id: "E020", nome: "Agitador Magnético", status: "Disponível", ultimaManutencao: "05/11" },
    ],
    "Com defeito": [
      { id: "E030", nome: "pHmetro", status: "Defeito", observacao: "Troca de eletrodo" },
    ],
  };
            ...
            <Fade in timeout={300 + index * 150}>
              <Paper elevation={4} sx={styles.card(card.cor)}>
                <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                  ...
                  <Box sx={styles.iconWrapper(card.cor)}>{card.icon}</Box>
                </Box>
          ...
          {selectedCard && (
            <>
              <Box sx={styles.modalHeader}>
                <Box sx={styles.modalIcon(selectedCard.cor)}>{selectedCard.icon}</Box>
                <Box>
              ...
              {detalhesMock[selectedCard.titulo]?.length > 0 ? (
                ...
                <Typography sx={styles.emptyState}>Nenhum equipamento detalhado disponível.</Typography>
              )}
...
export default IndicadoresEquipamentos;